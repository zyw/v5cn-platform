package cn.v5cn.platform.framework.mybatis.config;
...
import cn.v5cn.platform.framework.mybatis.handler.InjectionMetaObjectHandler;
import cn.v5cn.platform.framework.mybatis.handler.MybatisExceptionHandler;
import cn.v5cn.platform.framework.mybatis.interceptor.PlusDataPermissionInterceptor;
...
@MapperScan(value = "${mybatis-plus.mapperPackage}", annotationClass = Mapper.class)
